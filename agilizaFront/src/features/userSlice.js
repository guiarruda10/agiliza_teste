...
export const loginUser = createAsyncThunk(
  ...
  async ({ cpf }, thunkAPI) => {
    try {
      const response = await axios.post(`https://agiliza-api-rw4g.onrender.com/api/fila/status`, { cpf })
...
export const registerUser = createAsyncThunk(
  ...
  async ({ cpf, name }, thunkAPI) => {
    try {
      const response = await axios.post(`https://agiliza-api-rw4g.onrender.com/api/fila`, { cpf, name })
...
// lice Redux (sem alterações necessárias)
